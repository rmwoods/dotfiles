...
c.InteractiveShellApp.exec_lines = [
    'import numpy as np',
    'import pandas as pd',
    'from preteckt_sae import Constants as pc',
    'import preteckt_sae.utils as pu',
...
#         highlighting: 
#  igor, murphy, fruity, friendly, rrt, paraiso-dark, monokai, default, vs, perldoc, emacs, trac, lovelace, borland, autumn, pastie, abap, xcode, paraiso-light, bw, algol, arduino, vim, colorful, native, manni, tango, algol_nu, rainbow_dash
